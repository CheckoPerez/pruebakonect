...
<div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
    ...
    <div class="-mx-3 md:flex mb-6">
      <div class="md:w-1/2 px-3 mb-6 md:mb-0">
        ...
        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="grid-first-name" type="text" value="{{old('nombre')}}" name="nombre">
        @error('nombre')
      ...
      <div class="md:w-1/2 px-3">
        ...
        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-cat-name" type="text" value="{{old('categoria')}}" name="categoria">
        @error('categoria')
    ...
    <div class="-mx-3 md:flex mb-6">
      <div class="md:w-full px-3">
        ...
        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-ref" type="text" value="{{old('referencia')}}" name="referencia">
        @error('referencia')
    ...
    <div class="-mx-3 md:flex mb-2">
      <div class="md:w-1/2 px-3 mb-6 md:mb-0">
        ...
        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-precio" type="number" value="{{old('precio')}}" name="precio">
        @error('precio')
      ...
      <div class="md:w-1/2 px-3">
        ...
        <div class="relative">
          <input type="number" class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" id="grid-peso" value="{{old('peso')}}" name="peso">
          @error('peso')
      ...
      <div class="md:w-1/2 px-3">
        ...
        <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-stock" type="number" value="{{ old('stock') }}" name="stock">
        @error('stock')
